...
#' @usage LoadSurv( PID, UseExample = "default", DataPath=NULL,VocaPath=NULL)
...
#' @usage FindCovaSurv(PID, OutPath = "default", TimeY, EventY, VarsC_Prior = "default",
...
#' @usage SurvAsso(PID, OutPath = "default",
#'     TimeY, EventY,VarsX='all.x',VarsN = "single.factor",VarsSel = T,
#'     IncCova = T)
...
#' @usage VizSurvAsso(PID, OutPath = "default",VarsN = "single.factor",
...
#' @usage SurvPred(PID,OutPath = "default",TimeY,EventY,VarsX = "all.x",
...
#' @usage VizSurvPred(PID,OutPath = "default",Layout = "curve",
...
#' @usage VizSurvCompGroup(PID,OutPath = "default",TimeY,EventY,
